 ...
 * @date 5/17/14
 */
public class UpdateWeaponsEventHandler extends EventHandler<UpdateWeaponsEvent> {
    public UpdateWeaponsEventHandler(EventMultiplexer eventMultiplexer) {
        super(eventMultiplexer, UpdateWeaponsEvent.class);
    }

    @Override
    public void onEvent(UpdateWeaponsEvent event) {
